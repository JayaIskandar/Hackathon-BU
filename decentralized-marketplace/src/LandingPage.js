...
function LandingPage({ navigateToMarketplace }) { // Accept the prop
  return (
    <div className="LandingPage">
      ...
      <section className="hero bg-primary text-white text-center py-5">
        <div className="container">
          <h2 className="display-4">Welcome to Swap Squad</h2>
          <p className="lead">Buy, sell, and swap items securely in your local community.</p>
          <button className="btn btn-light btn-lg" onClick={navigateToMarketplace}>Explore Marketplace</button> {/* Update to call prop */}
        </div>
      </section>
